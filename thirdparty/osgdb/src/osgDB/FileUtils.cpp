...
void osgDB::setDataFilePathList(const FilePathList& filepath) { osgDB::Registry::instance()->setDataFilePathList(filepath); }

void osgDB::setDataFilePathList(const std::string& paths) { osgDB::Registry::instance()->setDataFilePathList(paths); }

osgDB::FilePathList& osgDB::getDataFilePathList() { return osgDB::Registry::instance()->getDataFilePathList(); }
...
std::string osgDB::findDataFile(const std::string& filename,const Options* options, CaseSensitivity caseSensitivity)
{
    return Registry::instance()->findDataFile(filename, options, caseSensitivity);
}

void osgDB::setLibraryFilePathList(const osgDB::FilePathList& filepaths) { osgDB::Registry::instance()->setLibraryFilePathList(filepaths); }

void osgDB::setLibraryFilePathList(const std::string& paths) { osgDB::Registry::instance()->setLibraryFilePathList(paths); }

osgDB::FilePathList& osgDB::getLibraryFilePathList() { return osgDB::Registry::instance()->getLibraryFilePathList(); }
