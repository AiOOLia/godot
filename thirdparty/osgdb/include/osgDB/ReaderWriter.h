...
#include <osgDB/AuthenticationMap.h>
...
class OSGDB_EXPORT ReaderWriter : public osg::Object
{
    public:
        ...
        virtual osg::Object* cloneType() const {
            ...
            return new ReaderWriter(*this, copyop);
        } virtual bool isSameKindAs(const osg::Object* obj) const {
            return dynamic_cast<const ReaderWriter*>(obj) != 0;
        ...
        virtual ReadResult readImage(char* buffer, int size, const Options* =NULL) const { return ReadResult(ReadResult::NOT_IMPLEMENTED); }
