...
#define OSGDB_FILEUTILS

#include <vector>
#include <deque>
#include <string>
#include <stdio.h>
#include <osgDB/Callbacks.h>
...
extern void setDataFilePathList(const FilePathList& filepath);

extern void setDataFilePathList(const std::string& paths);

extern FilePathList& getDataFilePathList();
...
extern void setLibraryFilePathList(const FilePathList& filepaths);

extern void setLibraryFilePathList(const std::string& paths);

extern FilePathList& getLibraryFilePathList();
